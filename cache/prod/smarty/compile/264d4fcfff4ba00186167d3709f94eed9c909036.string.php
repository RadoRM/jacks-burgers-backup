<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-11-15 12:23:26
         compiled from "264d4fcfff4ba00186167d3709f94eed9c909036" */ ?>
<?php /*%%SmartyHeaderCode:8838424115bed572e859732-57724639%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '264d4fcfff4ba00186167d3709f94eed9c909036' => 
    array (
      0 => '264d4fcfff4ba00186167d3709f94eed9c909036',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '8838424115bed572e859732-57724639',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bed572e8fd7a4_54400109',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bed572e8fd7a4_54400109')) {function content_5bed572e8fd7a4_54400109($_smarty_tpl) {?>


<?php $_smarty_tpl->_capture_stack[0][] = array('default', 'attributes', null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("forms/".((string)$_smarty_tpl->tpl_vars['field_template']->value)."/form-field-attributes-renderer.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
>
 ...
 <?php if ($_smarty_tpl->tpl_vars['required']->value) {?> <span class="required">*</span><?php }?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['show_label']->value) {?>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('form_error', array('form'=>$_smarty_tpl->tpl_vars['form']->value,'field'=>$_smarty_tpl->tpl_vars['field_name']->value)); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['form_error'][0][0]->formError(array('form'=>$_smarty_tpl->tpl_vars['form']->value,'field'=>$_smarty_tpl->tpl_vars['field_name']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                    <br />
                    <span class="error"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['message']->value,$_smarty_tpl);?>
</span>
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['form_error'][0][0]->formError(array('form'=>$_smarty_tpl->tpl_vars['form']->value,'field'=>$_smarty_tpl->tpl_vars['field_name']->value), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp30=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Unsupported field type '%type' in form-field.html",'type'=>$_tmp30),$_smarty_tpl);?>
</div>
                <?php }?>
        ...
        <?php if (!empty($_smarty_tpl->tpl_vars['label_attr']->value['help'])) {?>
            <span class="help-block"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['label_attr']->value['help'],$_smarty_tpl);?>
</span>
        <?php }?>
    </div>
