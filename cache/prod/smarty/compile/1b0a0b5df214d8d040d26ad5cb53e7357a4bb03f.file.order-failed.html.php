<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-11-27 09:25:41
         compiled from "/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/order-failed.html" */ ?>
<?php /*%%SmartyHeaderCode:18080643095bef0e882a3ee9-49650157%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b0a0b5df214d8d040d26ad5cb53e7357a4bb03f' => 
    array (
      0 => '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/order-failed.html',
      1 => 1542744042,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18080643095bef0e882a3ee9-49650157',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5bef0e884e2189_67569189',
  'variables' => 
  array (
    'store_name' => 0,
    'store_description' => 0,
...
<?php if ($_valid && !is_callable('content_5bef0e884e2189_67569189')) {function content_5bef0e884e2189_67569189($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/core/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?><!DOCTYPE html>
...
<div class="container cont-center">
            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-failed.top"),$_smarty_tpl);?>
            ...
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('type'=>"order",'name'=>"failed-order",'id'=>$_smarty_tpl->tpl_vars['failed_order_id']->value)); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"order",'name'=>"failed-order",'id'=>$_smarty_tpl->tpl_vars['failed_order_id']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>


            <div id="payment-failure" class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"You choose to pay by"),$_smarty_tpl);?>
 : <span class="payment-method"><?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"payment-module",'type'=>"module",'id'=>$_smarty_tpl->tpl_vars['PAYMENT_MODULE']->value)); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"payment-module",'type'=>"module",'id'=>$_smarty_tpl->tpl_vars['PAYMENT_MODULE']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TITLE']->value,$_smarty_tpl);?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"payment-module",'type'=>"module",'id'=>$_smarty_tpl->tpl_vars['PAYMENT_MODULE']->value), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <div class="panel-body">
                    <h3><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"We're sorry, a problem occured and your payment was not successful."),$_smarty_tpl);?>
</h3>
                    <?php if (null!==$_smarty_tpl->tpl_vars['failed_order_message']->value) {?>
                        <p><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['failed_order_message']->value,$_smarty_tpl);?>
</p>
                    <?php }?>
...
" role="button" class="btn btn-checkout"><span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Try again"),$_smarty_tpl);?>
</span></a>
                </div>
            </div>

            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"order",'name'=>"failed-order",'id'=>$_smarty_tpl->tpl_vars['failed_order_id']->value), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>


            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-failed.bottom"),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-failed.after-javascript-include"),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-failed.javascript-initialization"),$_smarty_tpl);?>
