<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-11-27 07:43:11
         compiled from "/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/contact-success.html" */ ?>
<?php /*%%SmartyHeaderCode:19044140955bebe17a28bdc9-38996948%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3215496a52149d7f9abb77e036d57c66f03e0395' => 
    array (
      0 => '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/contact-success.html',
      1 => 1542744042,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '19044140955bebe17a28bdc9-38996948',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5bebe17a4491a0_39972908',
  'variables' => 
  array (
    'store_name' => 0,
    'store_description' => 0,
...
<?php if ($_valid && !is_callable('content_5bebe17a4491a0_39972908')) {function content_5bebe17a4491a0_39972908($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/core/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?><!DOCTYPE html>
...
<?php $_tmp10=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["address"] = new Smarty_variable($_tmp6." ".$_tmp7." ".$_tmp8.", ".$_tmp9.", ".$_tmp10, null, 0);?>
    ...
    <div class="contact-success alert alert-success" style="text-align: center">
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('ifhook', array('rel'=>"contact.success")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['ifhook'][0][0]->ifHook(array('rel'=>"contact.success"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

           <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"contact.success"),$_smarty_tpl);?>

        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['ifhook'][0][0]->ifHook(array('rel'=>"contact.success"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

        <?php $_smarty_tpl->smarty->_tag_stack[] = array('elsehook', array('rel'=>"contact.success")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['elsehook'][0][0]->elseHook(array('rel'=>"contact.success"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

        <h2 class="icon-comments"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Thanks !"),$_smarty_tpl);?>
</h2>
        <p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Thanks for your message, we will contact as soon as possible."),$_smarty_tpl);?>
</p>
        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['elsehook'][0][0]->elseHook(array('rel'=>"contact.success"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
