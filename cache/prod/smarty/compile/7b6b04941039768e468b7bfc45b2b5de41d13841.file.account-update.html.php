<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-12-06 19:51:35
         compiled from "/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/account-update.html" */ ?>
<?php /*%%SmartyHeaderCode:15976846915bf17ef0ca1410-54649097%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b6b04941039768e468b7bfc45b2b5de41d13841' => 
    array (
      0 => '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/account-update.html',
      1 => 1542744041,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '15976846915bf17ef0ca1410-54649097',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5bf17ef102e996_28546713',
  'variables' => 
  array (
    'store_name' => 0,
    'store_description' => 0,
...
<?php if ($_valid && !is_callable('content_5bf17ef102e996_28546713')) {function content_5bf17ef102e996_28546713($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/core/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?><!DOCTYPE html>
...
<?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Update Profile"),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"/account/update"),$_smarty_tpl);?>
...
<div class="content">
    ...
    <div class="main">
        ...
        <article class="col-main" role="main" aria-labelledby="main-label">
            ...
            <h1 id="main-label" class="page-header"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Update Profile"),$_smarty_tpl);?>
</h1>

            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"account-update.top"),$_smarty_tpl);?>


            <?php $_smarty_tpl->smarty->_tag_stack[] = array('form', array('name'=>"thelia.front.customer.profile.update")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['form'][0][0]->generateForm(array('name'=>"thelia.front.customer.profile.update"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

            <form id="form-register" class="form-horizontal" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"/account/update"),$_smarty_tpl);?>
" method="post">
...
" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"/account"),$_smarty_tpl);?>
" />
                ...
                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"account-update.form-top"),$_smarty_tpl);?>
...
"<?php if ($_smarty_tpl->tpl_vars['required']->value) {?> aria-required="true" required<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['error_focus']->value)&&$_smarty_tpl->tpl_vars['error']->value) {?> autofocus<?php }?> disabled>
                                <?php if ($_smarty_tpl->tpl_vars['error']->value) {?>
                                    <span class="help-block"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['message']->value,$_smarty_tpl);?>
</span>
                                    <?php $_smarty_tpl->tpl_vars["error_focus"] = new Smarty_variable("true", null, 0);?>
...
"<?php if ($_smarty_tpl->tpl_vars['checked']->value) {?> checked<?php }?>  <?php if ($_smarty_tpl->tpl_vars['required']->value) {?> aria-required="true" required<?php }?>><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['label']->value,$_smarty_tpl);?>
                ...
                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"account-update.form-bottom"),$_smarty_tpl);?>


                <div class="form-group group-btn">
                    <div class="control-btn">
                        <button type="submit" class="btn btn-register"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Update"),$_smarty_tpl);?>
</button>
                    </div>
                </div><!--/.form-group-->
            </form>
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['form'][0][0]->generateForm(array('name'=>"thelia.front.customer.profile.update"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>


            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"account-update.bottom"),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"account-update.after-javascript-include"),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"account-update.javascript-initialization"),$_smarty_tpl);?>
