<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-11-27 17:34:40
         compiled from "/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/order-placed.html" */ ?>
<?php /*%%SmartyHeaderCode:594424175bebfb20703ef5-32339172%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d9a2553b9be974d620a641505d115273b0f4218' => 
    array (
      0 => '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/order-placed.html',
      1 => 1542744042,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '594424175bebfb20703ef5-32339172',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5bebfb2098d144_44574490',
  'variables' => 
  array (
    'store_name' => 0,
    'store_description' => 0,
...
<?php if ($_valid && !is_callable('content_5bebfb2098d144_44574490')) {function content_5bebfb2098d144_44574490($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/core/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?><!DOCTYPE html>
...
<?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Secure Payment"),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"/order/pay"),$_smarty_tpl);?>
...
<div class="container cont-center">
            <?php echo $_smarty_tpl->getSubTemplate ("misc/checkout-progress.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('step'=>"last"), 0);?>


            <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('type'=>"order",'name'=>"placed-order",'id'=>$_smarty_tpl->tpl_vars['placed_order_id']->value)); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"order",'name'=>"placed-order",'id'=>$_smarty_tpl->tpl_vars['placed_order_id']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('ifhook', array('rel'=>"order-placed.body")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['ifhook'][0][0]->ifHook(array('rel'=>"order-placed.body"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-placed.body",'module'=>((string)$_smarty_tpl->tpl_vars['PAYMENT_MODULE']->value)),$_smarty_tpl);?>

            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['ifhook'][0][0]->ifHook(array('rel'=>"order-placed.body"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

            <?php $_smarty_tpl->smarty->_tag_stack[] = array('elsehook', array('rel'=>"order-placed.body")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['elsehook'][0][0]->elseHook(array('rel'=>"order-placed.body"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                <div id="payment-success" class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Votre commande sera prête à l'heure selectionnée"),$_smarty_tpl);?>
 <span class="payment-method">
                    ...
                    <div class="panel-body">
                        <h3><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Thank you for the trust you place in us."),$_smarty_tpl);?>
</h3>
                        <p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"A summary of your order has been sent to the following address"),$_smarty_tpl);?>
 : <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['customer'][0][0]->customerDataAccess(array('attr'=>"email"),$_smarty_tpl);?>
</p>
                        <p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Your order will be confirmed by us upon receipt of your payment."),$_smarty_tpl);?>
</p>
                        <dl class="dl-horizontal">
                            <dt><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Order number"),$_smarty_tpl);?>
 : </dt>
                            <dd><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['REF']->value,$_smarty_tpl);?>
</dd>
                            <dt><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Date"),$_smarty_tpl);?>
 : </dt>
                            <dd><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_date'][0][0]->formatDate(array('date'=>$_smarty_tpl->tpl_vars['CREATE_DATE']->value,'output'=>"date"),$_smarty_tpl);?>
</dd>
                            <dt><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Total"),$_smarty_tpl);?>
 : </dt>
                            <dd><?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TOTAL_TAXED_AMOUNT']->value,$_smarty_tpl);?>
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['orderCurrency']->value,$_smarty_tpl);?>
<?php $_tmp9=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_money'][0][0]->formatMoney(array('number'=>$_tmp8,'symbol'=>$_tmp9),$_smarty_tpl);?>
</dd>
                        </dl>

                        

                        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-placed.additional-payment-info",'module'=>((string)$_smarty_tpl->tpl_vars['PAYMENT_MODULE']->value),'placed_order_id'=>$_smarty_tpl->tpl_vars['placed_order_id']->value),$_smarty_tpl);?>

                    </div>
                </div>
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['elsehook'][0][0]->elseHook(array('rel'=>"order-placed.body"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"order",'name'=>"placed-order",'id'=>$_smarty_tpl->tpl_vars['placed_order_id']->value), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
" role="button" class="btn btn-checkout-home"><span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Go home"),$_smarty_tpl);?>
</span></a>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-placed.after-javascript-include"),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"order-placed.javascript-initialization"),$_smarty_tpl);?>
