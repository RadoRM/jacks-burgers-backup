<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-11-20 23:08:36
         compiled from "/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/category.html" */ ?>
<?php /*%%SmartyHeaderCode:2370457405bebe322195dc3-09719609%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '852c2c712b40536e37ae596b5d7f8a9c0525fcc7' => 
    array (
      0 => '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/category.html',
      1 => 1542744042,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2370457405bebe322195dc3-09719609',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5bebe322412b88_85655364',
  'variables' => 
  array (
    'store_name' => 0,
    'store_description' => 0,
...
<?php if ($_valid && !is_callable('content_5bebe322412b88_85655364')) {function content_5bebe322412b88_85655364($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/core/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?><!DOCTYPE html>
...
<?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape((($tmp = @$_GET['limit'])===null||$tmp==='' ? 80 : $tmp),$_smarty_tpl);?>
<?php $_tmp8=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['limit'] = new Smarty_variable($_tmp8, null, 0);?>
<?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape((($tmp = @$_GET['page'])===null||$tmp==='' ? 1 : $tmp),$_smarty_tpl);?>
<?php $_tmp9=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['product_page'] = new Smarty_variable($_tmp9, null, 0);?>
<?php ob_start();?><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape((($tmp = @$_GET['order'])===null||$tmp==='' ? 'manual' : $tmp),$_smarty_tpl);?>
<?php $_tmp10=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['product_order'] = new Smarty_variable($_tmp10, null, 0);?>
...
<section>
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('type'=>"category",'id'=>((string)$_smarty_tpl->tpl_vars['category_id']->value),'name'=>"catechapo")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"category",'id'=>((string)$_smarty_tpl->tpl_vars['category_id']->value),'name'=>"catechapo"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

<h1><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TITLE']->value,$_smarty_tpl);?>
</h1>
    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"category",'id'=>((string)$_smarty_tpl->tpl_vars['category_id']->value),'name'=>"catechapo"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp11=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["amount"] = new Smarty_variable($_tmp11, null, 0);?>
