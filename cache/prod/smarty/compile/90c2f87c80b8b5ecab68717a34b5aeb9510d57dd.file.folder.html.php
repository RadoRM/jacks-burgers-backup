<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-11-20 21:54:36
         compiled from "/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/folder.html" */ ?>
<?php /*%%SmartyHeaderCode:12714599205bebe3ed3eed92-43785793%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '90c2f87c80b8b5ecab68717a34b5aeb9510d57dd' => 
    array (
      0 => '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/templates/frontOffice/default/folder.html',
      1 => 1542744042,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12714599205bebe3ed3eed92-43785793',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5bebe3ed697002_87798743',
  'variables' => 
  array (
    'store_name' => 0,
    'store_description' => 0,
...
<?php if ($_valid && !is_callable('content_5bebe3ed697002_87798743')) {function content_5bebe3ed697002_87798743($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/vhosts/jacksburgers.fr/web.jacksburgers.fr/core/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?><!DOCTYPE html>
...
<?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['folder'][0][0]->folderDataAccess(array('attr'=>"id"),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['folder_id'] = new Smarty_variable($_tmp1, null, 0);?>


    <?php if ($_smarty_tpl->tpl_vars['folder_id']->value) {?>
        <?php $_smarty_tpl->tpl_vars['breadcrumbs'] = new Smarty_variable(array(), null, 0);?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"folder_path",'type'=>"folder-path",'folder'=>$_smarty_tpl->tpl_vars['folder_id']->value)); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder_path",'type'=>"folder-path",'folder'=>$_smarty_tpl->tpl_vars['folder_id']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
$_smarty_tpl->tpl_vars['breadcrumbs']->value[] = array('title'=>$_tmp2,'url'=>$_tmp3);?>
        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder_path",'type'=>"folder-path",'folder'=>$_smarty_tpl->tpl_vars['folder_id']->value), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

    <?php }?>

    <?php if ($_smarty_tpl->tpl_vars['folder_id']->value) {?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"folder.seo.title",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder.seo.title",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php $_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['page_title'] = new Smarty_variable($_tmp4, null, 0);?>
        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder.seo.title",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
">
    ...
    <?php if ($_smarty_tpl->tpl_vars['folder_id']->value) {?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"folder.seo.meta",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder.seo.meta",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

            <?php echo $_smarty_tpl->getSubTemplate ("includes/meta-seo.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder.seo.meta",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<div class="content">
    <div >
        ...
        <div id="content">
<?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['folder'][0][0]->folderDataAccess(array('attr'=>"id"),$_smarty_tpl);?>
<?php $_tmp8=ob_get_clean();?><?php $_smarty_tpl->tpl_vars[((string)$_smarty_tpl->tpl_vars['folder_id']->value)] = new Smarty_variable($_tmp8, null, 0);?>
    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.top",'folder'=>((string)$_smarty_tpl->tpl_vars['folder_id']->value)),$_smarty_tpl);?>

    <div class="main">
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.main-top",'folder'=>((string)$_smarty_tpl->tpl_vars['folder_id']->value)),$_smarty_tpl);?>

        <div class="col-main contents-list" role="main" aria-labelledby="main-label">

        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.content-top",'folder'=>((string)$_smarty_tpl->tpl_vars['folder_id']->value)),$_smarty_tpl);?>


        <?php if ($_smarty_tpl->tpl_vars['folder_id']->value) {?>
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"folder",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <div id="folder-contents">
                    <div class="contents">
                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('ifloop', array('rel'=>"folder_content")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['ifloop'][0][0]->theliaIfLoop(array('rel'=>"folder_content"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                            <ul>
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"folder_content",'type'=>"content",'folder'=>((string)$_smarty_tpl->tpl_vars['ID']->value))); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder_content",'type'=>"content",'folder'=>((string)$_smarty_tpl->tpl_vars['ID']->value)), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                                    <li class="item">
                                        <article class="row">
                                            <?php $_smarty_tpl->smarty->_tag_stack[] = array('ifloop', array('rel'=>"content_thumbnail")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['ifloop'][0][0]->theliaIfLoop(array('rel'=>"content_thumbnail"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                                            <a class="col-md-5" href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
" tabindex="-1" class="content-image">
...
">
                                            ...
                                            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['ifloop'][0][0]->theliaIfLoop(array('rel'=>"content_thumbnail"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>


                                            <div class="content-info col-md-7">
                                                <h3 class="name"><a href="<?php echo $_smarty_tpl->tpl_vars['URL']->value;?>
"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TITLE']->value,$_smarty_tpl);?>
</a></h3>
...
">Lire la suite</a>
                                ...
                                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder_content",'type'=>"content",'folder'=>((string)$_smarty_tpl->tpl_vars['ID']->value)), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                            </ul>
                        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['ifloop'][0][0]->theliaIfLoop(array('rel'=>"folder_content"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('elseloop', array('rel'=>"folder_content")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['elseloop'][0][0]->theliaElseloop(array('rel'=>"folder_content"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                            <div class="folder-warning">
                                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"No Contents in this folder."),$_smarty_tpl);?>

                            </div>
                        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['elseloop'][0][0]->theliaElseloop(array('rel'=>"folder_content"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <div class="documents">
                    <ul>
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"blog.document",'type'=>"document",'folder'=>((string)$_smarty_tpl->tpl_vars['ID']->value))); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"blog.document",'type'=>"document",'folder'=>((string)$_smarty_tpl->tpl_vars['ID']->value)), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" target="_blank"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TITLE']->value,$_smarty_tpl);?>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"blog.document",'type'=>"document",'folder'=>((string)$_smarty_tpl->tpl_vars['ID']->value)), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <?php }?>
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folder",'type'=>"folder",'id'=>$_smarty_tpl->tpl_vars['folder_id']->value,'limit'=>"1"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <?php } else { ?>
            ...
            <ul>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('name'=>"folders",'type'=>"folder")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folders",'type'=>"folder"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['TITLE']->value,$_smarty_tpl);?>
                ...
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"folders",'type'=>"folder"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.content-bottom",'folder'=>((string)$_smarty_tpl->tpl_vars['folder_id']->value)),$_smarty_tpl);?>


        </div>
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.main-bottom",'folder'=>((string)$_smarty_tpl->tpl_vars['folder_id']->value)),$_smarty_tpl);?>

    </div>
    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.bottom",'folder'=>((string)$_smarty_tpl->tpl_vars['folder_id']->value)),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.after-javascript-include"),$_smarty_tpl);?>
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"folder.javascript-initialization"),$_smarty_tpl);?>
